/// View locations supported by SolidX
enum ViewLocation {
  shared(
    key: 'shared',
    displayName: "Shared",
    description: "Shared views in shared folder.",
  ),
  screen(
    key: 'screen',
    displayName: "Screen",
    description: "Screen-specific views in screen folder.",
  );
  ...
  static ViewLocation fromKey(String key) {
