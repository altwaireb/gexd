...
class ConstantCommand extends Command<int>
    with HasProjectData, HasTargetDirectory {
  final Logger _logger;
  final PromptServiceInterface _prompt;

  ConstantCommand({Logger? logger, PromptServiceInterface? prompt})
  ...
  @override
  String get description => 'Generate constant files';
...
''';
  ...
  Future<int> run() async {
    try {
      ...
      final ConstantData inputs = await ConstantInputs(
        argResults!,
        prompt: _prompt,
        template: template,
